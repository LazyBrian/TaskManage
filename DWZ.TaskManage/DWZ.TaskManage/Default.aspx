<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DWZ.TaskManage.Default" %>
    ...
    <script type="text/javascript">
        $(function () {
            DWZ.init("dwz/dwz.frag.xml", {
                ...
                loginUrl: "Account/login.aspx",	// 跳到登录页面
...
<body scroll="no">
                        ...
                        <ul class="tree treeFolder">
                            <li><a href="tabsPage.html" target="navTab">主框架面板</a>
                                <ul>
                                    ...
                                    <li><a href="Account/UserManage.aspx" target="navTab" rel="usermanage" fresh="true">用户管理</a></li>
    ...
    <div id="footer">Copyright &copy; 2010 <a href="demo_page2.html" target="dialog">Dgras</a> 粤ICP备05019125号-10</div>
